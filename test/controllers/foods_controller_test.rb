...
class FoodsControllerTest < ActionController::TestCase
  ...
  test "should create food" do
    assert_difference('Food.count') do
      post :create, food: { category: @food.category, name: @food.name, quantity: @food.quantity }
    end
  ...
  test "should update food" do
    patch :update, id: @food, food: { category: @food.category, name: @food.name, quantity: @food.quantity }
    assert_redirected_to food_path(assigns(:food))
  end
